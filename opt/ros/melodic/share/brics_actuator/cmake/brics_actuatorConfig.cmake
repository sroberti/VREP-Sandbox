...
if("FALSE" STREQUAL "TRUE")
  set(brics_actuator_SOURCE_PREFIX /tmp/binarydeb/ros-melodic-brics-actuator-0.7.0)
  set(brics_actuator_DEVEL_PREFIX /tmp/binarydeb/ros-melodic-brics-actuator-0.7.0/obj-x86_64-linux-gnu/devel)
  ...
  set(brics_actuator_INSTALL_PREFIX /opt/ros/melodic)
...
if(NOT "include " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'brics_actuator' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/opt/ros/melodic/${idir}'.  ${_report}")
    endif()
