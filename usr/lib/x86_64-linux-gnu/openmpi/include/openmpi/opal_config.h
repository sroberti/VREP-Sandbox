...
#define MCA_io_romio314_COMPLETE_CONFIGURE_FLAGS " FROM_OMPI=yes CC='gcc' CFLAGS='-DNDEBUG -g -O2 -fdebug-prefix-map=/build/openmpi-v3Q8AB/openmpi-2.1.1=. -fstack-protector-strong -Wformat -Werror=format-security -finline-functions -fno-strict-aliasing -pthread -D__EXTENSIONS__' CPPFLAGS='-Wdate-time -D_FORTIFY_SOURCE=2   -I/build/openmpi-v3Q8AB/openmpi-2.1.1/opal/mca/event/libevent2022/libevent -I/build/openmpi-v3Q8AB/openmpi-2.1.1/opal/mca/event/libevent2022/libevent/include' FFLAGS='-g -O2 -fdebug-prefix-map=/build/openmpi-v3Q8AB/openmpi-2.1.1=. -fstack-protector-strong' LDFLAGS='-Wl,-Bsymbolic-functions -Wl,-z,relro   -L/usr//lib' --enable-shared --disable-static  --prefix=/usr --disable-aio --disable-weak-symbols --enable-strict"
...
#define OPAL_PACKAGE_STRING "Open MPI buildd@lcy01-amd64-009 Distribution"
