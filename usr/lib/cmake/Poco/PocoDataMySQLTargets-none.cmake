...
set_target_properties(Poco::DataMySQL PROPERTIES
  IMPORTED_LOCATION_NONE "${_IMPORT_PREFIX}/lib/libPocoDataMySQL.so.50"
  IMPORTED_SONAME_NONE "libPocoDataMySQL.so.50"
  )

list(APPEND _IMPORT_CHECK_TARGETS Poco::DataMySQL )
list(APPEND _IMPORT_CHECK_FILES_FOR_Poco::DataMySQL "${_IMPORT_PREFIX}/lib/libPocoDataMySQL.so.50" )
